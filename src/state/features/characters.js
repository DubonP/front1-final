...
export const availableCharactersSelector = (state) =>
  state.cart.availableCharacters;
export const selectedCharactersSelector = (state) =>
  state.cart.selectedCharacters;
...
export const fetchAvailableCharacters = () => ({
  type: "cart/fetchAvailableCharacters",
});
...
export const setAvailableCharacters = (characters) => ({
  type: "cart/setAvailableCharacters",
  payload: characters,
});
...
export const setIsFavorito = (isFavorito) => ({
  type: "cart/isFavorito",
  payload: isFavorito,
});
export const getFavCharacter = () => ({ type: "cart/getFavCharacter" });
export const setFavoriteCharacters = (favoriteCharacters) => ({
  type: "cart/setFavoriteCharacters",
